		...
		>
			<div className="space-y-4">
				...
				<form className="space-y-3" onSubmit={handleSubmit}>
					<div className="grid gap-3 sm:grid-cols-[minmax(0,1fr)_150px_auto]">
						<div className="flex flex-col gap-1">
							...
							>
								{t(
									"dashboard.sections.periodExpenses.labels.name"
								)}
							</label>
							<input
								id="period-name"
								...
								placeholder={t(
									"dashboard.sections.periodExpenses.placeholders.name"
								)}
						...
						<div className="flex flex-col gap-1">
							...
							>
								{t(
									"dashboard.sections.periodExpenses.labels.amount"
								)}
							</label>
							<input
								id="period-amount"
								...
								placeholder={t(
									"dashboard.sections.periodExpenses.placeholders.amount"
								)}
								type="number"
								min="0"
								step="0.01"
					...
					<div className="flex flex-col gap-1">
						...
						<input
							...
							placeholder={t(
								"dashboard.sections.periodExpenses.placeholders.note"
							)}
				...
				<div
					className={
						items.length > 3
							? "max-h-[26rem] overflow-y-auto pr-2 scrollable-section"
							: ""
					}
				>
						...
						{items.length === 0 ? (
							...
							items.map((item) => (
								...
								>
									...
									>
										{t(
											"dashboard.sections.periodExpenses.remove"
										)}
									</button>
								</li>
							))
