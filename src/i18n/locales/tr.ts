export const tr = {
  ...
  auth: {
    ...
    subtitle: "Gelir ve giderlerini kaydederek ev bütçeni kontrol altında tut.",
    tabs: {
      login: "Giriş Yap",
      register: "Kayıt Ol",
    },
    ...
    helper:
      "Verilerin sunucuda saklanır; aynı hesapla farklı cihazlardan erişebilirsin. Kullanıcı adları benzersiz olmalıdır.",
    buttons: {
      login: "Giriş Yap",
      register: "Kayıt Ol",
    },
  ...
  // (copy controls removed)
    ...
    sections: {
      ...
      subscriptions: {
        title: "Abonelik Giderleri",
        subtitle: "Netflix, Spotify gibi düzenli ödemeleri gir.",
        labels: {
          name: "Abonelik adı",
          amount: "Tutar",
          note: "Not (opsiyonel)",
        ...
        remove: "Sil",
        perMonth: "{{amount}} / ay",
        summary: "Toplam abonelik: {{amount}} / ay",
        count: "{{count}} kayıt",
      },
      installments: {
        ...
        helper:
          "Toplam ve taksit sayısını girersen aylık ödeme otomatik hesaplanır.",
        countOptions: {
  ...
  currentOverTotal: "· {{current}}/{{total}} taksit",
    ...
    summary: {
      ...
      leftoverNegative: "Giderlerin gelirlerini aştı, planını gözden geçir.",
      helper: "Kalan bütçeyi pozitif tutmak için dönem içi giderlerini gözden geçir.",
    },
    history: {
      title: "Aylık Geçmiş",
    ...
    tip: {
      ...
      body:
        "Her ayın başında gelirlerini ekledikten sonra sabit giderlerini (abonelik ve taksit) gir. Kalan tutarı dönem içi harcamalara limit olarak belirle ve tüm giderlerini bu limitte tutmaya çalış.",
    },
    loading: {
